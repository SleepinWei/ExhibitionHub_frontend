<!-- 使用 npm install element-china-area-data -S 安装相关库 -->

<template>
    <div class="addressSelecotr">
        <div class="block">
            <el-cascader v-model="value" class="hvr-shadow" :options="areaOption" filterable @change="handleChange" />
        </div>
    </div>
</template>
